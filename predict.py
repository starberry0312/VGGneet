...
test_pth=r'D:\PyCharm\VGGnet\test\cat\Siamese_158_jpg.rf.fad9e8f3a0a6866d0f9b5adc3953b876.jpg'#设置可以检测的图像
...
net =vgg16()#输入网络
model=torch.load(r"D:\PyCharm\VGGnet\DogandCat15.pth",map_location=device)#已训练完成的结果权重输入
